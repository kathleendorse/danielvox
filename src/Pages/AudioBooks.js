...
function AudioBooks(){
    ...
    return(
        <Container fluid id="audioBook audiobook-section audio-s" className="panels">
            <Row><br></br></Row>
            <Row>
                <Col><br></br></Col>
                <Col xs={10}>
            ...
            <Row>
                ...
                <Col xs={10}> 
                    ...
                    {/* <Carousel responsive={responsive}>
                        <Card style={{ width: "14rem"  }} className="audio-card"> */}
                        {/* <Card style={{ width: '18rem' }}> */}
                            {/* <Card.Body>
                                <Card.Title>Science Fiction and Fantasy</Card.Title>
                                <Card.Img src="https://res.cloudinary.com/katedorse/image/upload/v1611778170/DanielVox/axc0-011213.jpg" />
                                ...
                                {/* <audio
                                        controls
                                        src="https://samples.audible.com/bk/acx0/011213/bk_acx0_011213_sample.mp3"
                                        type="audio/mpeg"
                                        >                            
                                        Your browser does not support the
                                        <code>audio</code> element.
                        ...
                        <Card style={{ width: "15rem"}} className="audio-card"> */}
                        {/* <Card style={{ width: '18rem' }}> */}
                            {/* <Card.Img variant="bottom" src="holder.js/100px180" />
                            <Card.Body>
                                <Card.Title>Card Title</Card.Title>
